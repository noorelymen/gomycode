export const moviesData = [
  ...
  },
  {
    ...
    description:
      "Thor embarks on a journey unlike anything he's ever faced -- a quest for inner peace. However, his retirement gets interrupted by Gorr the God Butcher, a galactic killer who seeks the extinction of the gods. To combat the threat.",
    category: "action",
    rating: "6.3",
    poster:
  ...
  {
    id: 4,
    title: "Spider no way home",
    description:
      "Spider-Man: No Way Home is a 2021 American superhero film based on the Marvel Comics character Spider-Man, co-produced by Columbia Pictures and Marvel Studios and distributed by Sony Pictures Releasing. It is the sequel to Spider-Man: Homecoming (2017) and Spider-Man: Far From Home (2019)",
    category: "action",
    rating: "8.2",
    poster: "https://fr.web.img4.acsta.net/pictures/21/11/16/10/01/4860598.jpg",
    trailer: "JfVOs4VSpmA",
  },
  {
    id: 5,
